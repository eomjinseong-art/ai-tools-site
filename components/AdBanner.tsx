  ...
  if (!ad.image_url) {
    return (
      <a
        ...
        className={`flex flex-col items-center justify-center gap-1.5 rounded-xl border border-gray-200 bg-white px-4 py-6 text-center text-sm font-semibold text-gray-900 hover:border-brand-300 dark:border-gray-800 dark:bg-[#0b1220] dark:text-gray-100 dark:hover:border-brand-500/50 ${className ?? ""}`}
      >
        <span>{ad.name}</span>
